...
def test_produce_encodes_string_key_and_value_and_polls_zero():
    ...
    wrapper.produce(KafkaTopics.telemetry_raw, 'device-1', '{"temp":1}', on_delivery=callback)
...
def test_produce_retries_on_buffer_error_then_succeeds():
    ...
    wrapper.produce(KafkaTopics.telemetry_raw, b'k', b'v', attempts=3, poll_timeout=0.25)
